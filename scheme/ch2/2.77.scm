...
; 2.77 apply-generic is called twice, first when dispatching on the 'complex' type tag, then on the 'rectangular' type tag
; c2 is (list 'complex 'rectangular 3 4)
(newline)
(display (magnitude c2)) ; 5
